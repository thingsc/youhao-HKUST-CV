...
本研究提出了一种有源整流无线电机（Active-Rectifier Wireless Motor, AR-WM）系统，并采用双边移相控制（Dual-Side Phase-Shift Control, DS-PSC）策略，实现双侧相位同步、无功功率消除和最大效率点跟踪。相关成果发表于 *IEEE Transactions on Power Electronics*。
