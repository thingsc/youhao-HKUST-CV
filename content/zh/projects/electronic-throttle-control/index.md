...
date: 2024-08-01
summary: 面向车辆线控节气门系统的有限时间与固定时间控制算法。
tags:
  - 滑模控制
  - 自适应控制
  - 汽车电子控制
...
本研究方向面向具有参数不确定性、集总不确定性以及执行器约束的车辆线控节气门系统，开展基于扰动观测器的自适应有限时间和固定时间滑模控制研究。相关成果发表于 *IEEE Transactions on Vehicular Technology*、*Neural Computing and Applications* 和 *Mechanical Systems and Signal Processing*。
